(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function a(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=a(o);fetch(o.href,r)}})();function I(e){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e)}function ee(e){return new Date(e).toLocaleDateString("pt-BR")}function Be(e){return{ativo:"badge-success",potencial:"badge-info",em_negociacao:"badge-warning",inativo:"badge-neutral",planejamento:"badge-info",em_execucao:"badge-warning",pausado:"badge-neutral",concluido:"badge-success",cancelado:"badge-danger",pendente:"badge-warning",pago:"badge-success",atrasado:"badge-danger"}[e]||"badge-neutral"}function Le(e){return{ativo:"Ativo",potencial:"Potencial",em_negociacao:"Em Negociação",inativo:"Inativo",planejamento:"Planejamento",em_execucao:"Em Execução",pausado:"Pausado",concluido:"Concluído",cancelado:"Cancelado",pendente:"Pendente",pago:"Pago",atrasado:"Atrasado",recebimento:"Recebimento",pagamento:"Pagamento"}[e]||e}let Y=null;function v(e,t="success"){Y||(Y=document.createElement("div"),Y.className="toast-container",document.body.appendChild(Y));const a=document.createElement("div");a.className=`toast ${t}`,a.textContent=e,Y.appendChild(a),setTimeout(()=>{a.remove()},3e3)}const ue={};function M(e,t){ue[e]=t}function oe(e){window.history.pushState({},"",e),we()}function we(){const e=window.location.pathname,t=ue[e]||ue["/"];t&&t()}window.addEventListener("popstate",we);const qe="/api";class Oe extends Error{constructor(t,a){super(a),this.status=t,this.name="ApiError"}}async function g(e,t={}){const a=await fetch(`${qe}${e}`,{...t,credentials:"include",cache:"no-store",headers:{"Content-Type":"application/json",...t.headers}});if(!a.ok){const i=await a.json().catch(()=>({detail:"Erro desconhecido"}));throw new Oe(a.status,i.detail||"Erro na requisição")}if(a.status!==204)return a.json()}const U={login:e=>g("/auth/login",{method:"POST",body:JSON.stringify(e)}),logout:()=>g("/auth/logout",{method:"POST"}),me:()=>g("/auth/me"),register:e=>g("/auth/register",{method:"POST",body:JSON.stringify(e)}),updateProfile:(e,t)=>g(`/auth/users/${e}`,{method:"PUT",body:JSON.stringify(t)})},T={list:e=>{const t=e?"?"+new URLSearchParams(e).toString():"";return g(`/clientes${t}`)},get:e=>g(`/clientes/${e}`),create:e=>g("/clientes",{method:"POST",body:JSON.stringify(e)}),update:(e,t)=>g(`/clientes/${e}`,{method:"PUT",body:JSON.stringify(t)}),delete:e=>g(`/clientes/${e}`,{method:"DELETE"}),addInteracao:(e,t)=>g(`/clientes/${e}/interacoes`,{method:"POST",body:JSON.stringify(t)})},re={list:e=>{const t=e?"?"+new URLSearchParams(e).toString():"";return g(`/projetos${t}`)},get:e=>g(`/projetos/${e}`),create:e=>g("/projetos",{method:"POST",body:JSON.stringify(e)}),update:(e,t)=>g(`/projetos/${e}`,{method:"PUT",body:JSON.stringify(t)}),delete:e=>g(`/projetos/${e}`,{method:"DELETE"}),addEntregavel:(e,t)=>g(`/projetos/${e}/entregaveis`,{method:"POST",body:JSON.stringify(t)}),updateEntregavel:(e,t,a)=>g(`/projetos/${e}/entregaveis/${t}`,{method:"PUT",body:JSON.stringify(a)})},ne={list:e=>{const t=e?"?"+new URLSearchParams(e).toString():"";return g(`/contratos${t}`)},alertas:(e=30)=>g(`/contratos/alertas?dias=${e}`),get:e=>g(`/contratos/${e}`),create:e=>g("/contratos",{method:"POST",body:JSON.stringify(e)}),update:(e,t)=>g(`/contratos/${e}`,{method:"PUT",body:JSON.stringify(t)}),delete:e=>g(`/contratos/${e}`,{method:"DELETE"})},J={list:e=>{const t=e?"?"+new URLSearchParams(e).toString():"";return g(`/financeiro${t}`)},create:e=>g("/financeiro",{method:"POST",body:JSON.stringify(e)}),update:(e,t)=>g(`/financeiro/${e}`,{method:"PUT",body:JSON.stringify(t)}),delete:e=>g(`/financeiro/${e}`,{method:"DELETE"}),fluxoCaixa:(e=6)=>g(`/financeiro/fluxo-caixa?meses=${e}`),dashboard:()=>g("/financeiro/dashboard"),atividades:(e=10)=>g(`/financeiro/atividades?limit=${e}`)},ie={list:e=>{const t=e?"?"+new URLSearchParams(e).toString():"";return g(`/agendamentos${t}`)},create:e=>g("/agendamentos",{method:"POST",body:JSON.stringify(e)}),update:(e,t)=>g(`/agendamentos/${e}`,{method:"PUT",body:JSON.stringify(t)}),delete:e=>g(`/agendamentos/${e}`,{method:"DELETE"})},V={list:e=>{const t=e?"?"+new URLSearchParams(e).toString():"";return g(`/orcamentos${t}`)},get:e=>g(`/orcamentos/${e}`),create:e=>g("/orcamentos",{method:"POST",body:JSON.stringify(e)}),update:(e,t)=>g(`/orcamentos/${e}`,{method:"PUT",body:JSON.stringify(t)}),delete:e=>g(`/orcamentos/${e}`,{method:"DELETE"}),calculate:e=>g("/orcamentos/calculate",{method:"POST",body:JSON.stringify(e)})},K={list:()=>g("/config/"),get:e=>g(`/config/${e}`),update:(e,t)=>g(`/config/${e}`,{method:"PUT",body:JSON.stringify(t)})};let te=null;function ke(){return te}async function Te(){try{return te=await U.me(),!0}catch{return te=null,!1}}function le(e){var a;e.innerHTML=`
  ...
  `,document.getElementById("login-form").addEventListener("submit",async i=>{i.preventDefault();const o=document.getElementById("email").value,r=document.getElementById("password").value;try{te=(await U.login({email:o,password:r})).user,v("Login realizado com sucesso!","success"),oe("/dashboard")}catch(s){v(s.message||"Erro ao fazer login","error")}}),(a=document.getElementById("register-link"))==null||a.addEventListener("click",i=>{i.preventDefault(),Re(e)})}function Re(e){var a;e.innerHTML=`
    <div class="login-container">
      <div class="login-box">
  ...
  `,document.getElementById("register-form").addEventListener("submit",async i=>{i.preventDefault();const o=document.getElementById("name").value,r=document.getElementById("email").value,s=document.getElementById("password").value;try{await U.register({name:o,email:r,password:s}),v("Conta criada! Faça login.","success"),le(e)}catch(x){v(x.message||"Erro ao criar conta","error")}}),(a=document.getElementById("login-link"))==null||a.addEventListener("click",i=>{i.preventDefault(),le(e)})}async function Ne(){try{await U.logout(),te=null,v("Logout realizado","success"),oe("/")}catch{v("Erro ao fazer logout","error")}}/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const it=[["path",{d:"M11 6a13 13 0 0 0 8.4-2.8A1 1 0 0 1 21 4v12a1 1 0 0 1-1.6.8A13 13 0 0 0 11 14H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2z"}],["path",{d:"M6 14a12 12 0 0 0 2.4 7.2 2 2 0 0 0 3.2-2.4A8 8 0 0 1 10 14"}],["path",{d:"M8 6v8"}]];/**
 * @license lucide v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const rt=[["path",{d:"M4 5h16"}],["path",{d:"M4 12h16"}],["path",{d:"M4 19h16"}]];/**
 * @license lucide v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ut=[["path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"}],["path",{d:"M16 3.128a4 4 0 0 1 0 7.744"}],["path",{d:"M22 21v-2a4 4 0 0 0-3-3.87"}],["circle",{cx:"9",cy:"7",r:"4"}]],vt={rocket:dt,dashboard:at,users:ut,filter:et,calendar:Fe,"file-text":Ke,clipboard:Xe,folder:Qe,dollar:Ye,settings:ct,edit:st,trash:pt,party:nt,alert:mt,megaphone:it,handshake:tt,briefcase:He,file:We,"arrow-down":Je,"arrow-up":Ve,"folder-open":Ze,check:Ue,x:Ge,logout:ot,menu:rt,plus:lt};function E(e,t=""){const a=vt[e];return a?a.toSvg({class:`icon ${t}`}):(console.warn(`Icon '${e}' not found.`),"")}const Me=document.createElement("style");Me.textContent=`
    .icon {
        width: 20px;
        height: 20px;
...
`;document.head.appendChild(Me);function gt(e,t){var i,o;const a=ke();return e.innerHTML=`
    <div class="app">
      <aside class="sidebar">
        ...
        <div style="margin-top: auto; padding-top: var(--spacing-lg); border-top: 1px solid var(--color-border);">
          <div style="display: flex; align-items: center; gap: var(--spacing-md); margin-bottom: var(--spacing-md);">
            <div style="width: 36px; height: 36px; border-radius: 50%; background: var(--color-primary); display: flex; align-items: center; justify-content: center; font-weight: 600;">
              ${((i=a==null?void 0:a.name)==null?void 0:i.charAt(0).toUpperCase())||"U"}
            </div>
            <div>
  ...
  `,document.querySelectorAll(".nav-item[data-page]").forEach(r=>{r.addEventListener("click",()=>{const s=r.dataset.page;oe(`/${s}`)})}),(o=document.getElementById("logout-btn"))==null||o.addEventListener("click",Ne),document.getElementById("page-content")}async function bt(e){e.innerHTML='<div class="loading"><div class="spinner"></div></div>';try{const t=await J.dashboard(),i=new Date().toLocaleString("pt-BR",{month:"long"}),o=[],r=[{titulo:"Janeiro Branco e Roxo",desc:"Saúde mental e hanseníase"},{titulo:"Confraternização Universal",desc:"",data:"01/01"}];e.innerHTML=`
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(350px, 1fr)); gap: var(--spacing-lg); margin-bottom: var(--spacing-xl);">
        ...
        <div class="card" style="height: 100%;">
          <div class="card-header" style="border: none; padding-bottom: 0;">
            <h2 class="card-title" style="display: flex; align-items: center; gap: var(--spacing-sm);">
              <span style="display: flex; align-items: center; color: var(--color-warning);">${E("party","w-6 h-6")}</span> Aniversariantes de ${i}
            </h2>
          </div>
    ...
    `}catch(t){console.error(t),e.innerHTML='<div class="empty-state">Erro ao carregar dashboard</div>'}}function H(e,t,a,i){return`
    <div class="card" style="display: flex; flex-direction: column; height: 100%;">
      <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: var(--spacing-sm);">
        ...
        <span style="color: var(--color-text-muted); display: flex; align-items: center;">${i}</span>
      </div>
...
${$}`}try{w?(await T.update(w,f),v("Atualizado com sucesso","success")):(await T.create(f),v("Criado com sucesso","success")),t.classList.remove("active"),ve(e)}catch($){v($.message||"Erro ao salvar","error")}});function h(){a.reset(),document.querySelectorAll("details").forEach(n=>n.open=!1),document.querySelector("details").open=!0}}let A=[],$e=[],F=null;async function xt(e){e.innerHTML='<div class="loading"><div class="spinner"></div></div>';try{[A,$e]=await Promise.all([re.list(),T.list()]),Et(e)}catch(t){e.innerHTML='<div class="empty-state">Erro ao carregar projetos</div>',console.error(t)}}function Et(e){e.innerHTML=`
    ...
    `}function _t(e){const t=document.getElementById("projeto-form"),a=document.getElementById("save-btn"),i=document.getElementById("cancel-btn"),o=document.getElementById("form-title"),r=document.getElementById("cliente_id");document.querySelectorAll('input[name="entity_type"]').forEach(s=>{s.addEventListener("change",x=>{x.target.value==="cliente"?(r.innerHTML='<option value="">Selecione...</option>'+ge(),r.disabled=!1):(r.innerHTML='<option value="placeholder">Parceiro Exemplo (Mock)</option>',r.disabled=!0)})}),e.addEventListener("click",s=>{var h,y;const b=s.target.closest(".edit-btn");if(b){const u=b.dataset.id,n=A.find(w=>w.id===u);n&&(F=u,document.getElementById("projeto-id").value=n.id,document.getElementById("nome").value=n.nome,document.querySelector('input[name="entity_type"][value="cliente"]').checked=!0,r.innerHTML='<option value="">Selecione...</option>'+ge(),r.value=n.cliente_id,document.getElementById("descricao").value=n.descricao||"",document.getElementById("prazo_inicio").value=((h=n.prazo_inicio)==null?void 0:h.split("T")[0])||"",document.getElementById("prazo_final").value=((y=n.prazo_final)==null?void 0:y.split("T")[0])||"",document.getElementById("status").value=n.status,o.textContent="Editar Projeto",a.textContent="Atualizar Projeto",i.style.display="block",window.scrollTo({top:0,behavior:"smooth"}))}}),e.addEventListener("click",async s=>{const b=s.target.closest(".delete-btn");if(b&&confirm("Tem certeza que deseja excluir este projeto?")){const h=b.dataset.id;try{await re.delete(h),v("Projeto excluído","success"),A=A.filter(y=>y.id!==h),document.getElementById("projects-list-container").innerHTML=be()}catch{v("Erro ao excluir projeto","error")}}}),i.addEventListener("click",()=>{Ce(t,a,i,o)}),t.addEventListener("submit",async s=>{if(s.preventDefault(),document.querySelector('input[name="entity_type"]:checked').value==="parceiro"){v("Cadastro de parcerias estará disponível em breve.","warning");return}const b={nome:document.getElementById("nome").value,cliente_id:document.getElementById("cliente_id").value,descricao:document.getElementById("descricao").value||void 0,prazo_inicio:document.getElementById("prazo_inicio").value||void 0,prazo_final:document.getElementById("prazo_final").value||void 0,status:document.getElementById("status").value};a.disabled=!0,a.textContent="Salvando...";try{if(F){const h=await re.update(F,b);v("Projeto atualizado!","success");const y=A.findIndex(u=>u.id===F);y!==-1&&(A[y]=h)}else{const h=await re.create(b);v("Projeto criado!","success"),A.push(h)}document.getElementById("projects-list-container").innerHTML=be(),Ce(t,a,i,o)}catch(h){v(h.message||"Erro ao salvar","error")}finally{a.disabled=!1,a.textContent=F?"Atualizar Projeto":"Adicionar Projeto"}})}function Ce(e,t,a,i){F=null,e.reset(),i.textContent="Cadastrar Projeto",t.textContent="Adicionar Projeto",a.style.display="none";const o=document.querySelector('input[name="entity_type"][value="cliente"]');o&&(o.checked=!0,o.dispatchEvent(new Event("change")))}let ce=[],ae=[],se=[];async function ye(e){e.innerHTML='<div class="loading"><div class="spinner"></div></div>';try{[ce,ae,se]=await Promise.all([ne.list(),T.list(),V.list()]),se||(se=[]),wt(e)}catch(t){console.error("Erro ao carregar dados:",t),e.innerHTML='<div class="empty-state">Erro ao carregar dados. Tente novamente.</div>'}}function wt(e){e.innerHTML=`
    <div class="page-header">
    ...
    </div>`}function It(e){const t=ae.find(s=>s.id===e.cliente_id),a=new Date,i=new Date(e.data_termino),o=Math.ceil((i.getTime()-a.getTime())/(1e3*60*60*24));let r="badge-success";return o<=0?r="badge-danger":o<=30&&(r="badge-warning"),`
    <tr>
      ...
      <td>
        ${ee(e.data_termino)}
        <span class="badge ${r}" style="margin-left: 0.5rem;">
          ${o<=0?"Vencido":o+" dias"}
        </span>
      </td>
      <td>
  ...
  `}function Ct(){const e=document.querySelectorAll(".tab-btn"),t=document.querySelectorAll(".tab-content");e.forEach(a=>{a.addEventListener("click",()=>{const i=a.dataset.tab;e.forEach(o=>{o.style.borderBottom="2px solid transparent",o.style.color="#666",o.classList.remove("active")}),a.style.borderBottom="2px solid var(--primary-color)",a.style.color="inherit",a.classList.add("active"),t.forEach(o=>{o.style.display="none"}),document.getElementById(`tab-content-${i}`).style.display="block"})})}function St(e){var s,x,b,h;const t=document.getElementById("contrato-modal"),a=document.getElementById("contrato-form");(s=document.getElementById("add-contrato-btn"))==null||s.addEventListener("click",()=>{a.reset(),document.getElementById("contrato-id").value="",document.getElementById("modal-title").textContent="Novo Contrato",t.classList.add("active")});const i=()=>t.classList.remove("active");(x=document.getElementById("close-modal"))==null||x.addEventListener("click",i),(b=document.getElementById("cancel-btn"))==null||b.addEventListener("click",i),document.querySelectorAll(".edit-btn").forEach(y=>{y.addEventListener("click",()=>{const u=y.dataset.id,n=ce.find(w=>w.id===u);n&&(document.getElementById("contrato-id").value=n.id,document.getElementById("numero").value=n.numero,document.getElementById("cliente_id").value=n.cliente_id,document.getElementById("valor").value=n.valor.toString(),document.getElementById("data_inicio").value=n.data_inicio.split("T")[0],document.getElementById("data_termino").value=n.data_termino.split("T")[0],document.getElementById("condicoes").value=n.condicoes||"",document.getElementById("modal-title").textContent="Editar Contrato",t.classList.add("active"))})}),document.querySelectorAll(".delete-btn").forEach(y=>{y.addEventListener("click",async()=>{const u=y.dataset.id;if(confirm("Tem certeza?"))try{await ne.delete(u),v("Contrato excluído","success"),ye(e)}catch(n){v(n.message,"error")}})}),a.addEventListener("submit",async y=>{y.preventDefault();const u=document.getElementById("contrato-id").value,n={numero:document.getElementById("numero").value,cliente_id:document.getElementById("cliente_id").value,valor:parseFloat(document.getElementById("valor").value),data_inicio:document.getElementById("data_inicio").value,data_termino:document.getElementById("data_termino").value,condicoes:document.getElementById("condicoes").value||void 0};try{u?(await ne.update(u,n),v("Contrato atualizado","success")):(await ne.create(n),v("Contrato criado","success")),t.classList.remove("active"),ye(e)}catch(w){v(w.message,"error")}});const o=document.querySelectorAll('input[name="tipo_entidade"]'),r=document.getElementById("gerador_entidade_id");o.forEach(y=>{y.addEventListener("change",u=>{u.target.value==="cliente"?r.innerHTML='<option value="">Selecione o Cliente...</option>'+ae.map(w=>`<option value="${w.id}">${w.nome}</option>`).join(""):r.innerHTML='<option value="">Selecione o Parceiro...</option><option value="p1">Parceiro Exemplo Ltda</option>'})}),(h=document.getElementById("btn-gerar-preview"))==null||h.addEventListener("click",()=>{v("Funcionalidade de geração em desenvolvimento","info")})}let Q=[],Ie=[],W=null,Z=null;async function fe(e){e.innerHTML='<div class="loading"><div class="spinner"></div></div>';try{const[t,a,i]=await Promise.all([J.list(),T.list(),J.fluxoCaixa(6).catch(()=>null)]);Q=t,Ie=a,Z=i,Bt(e)}catch(t){e.innerHTML='<div class="empty-state">Erro ao carregar dados financeiros</div>',console.error(t)}}function Bt(e){e.innerHTML=`
    ...
    </div>`}function kt(e){const t=Math.max(e.total_recebimentos,e.total_pagamentos,1),a=Math.round(e.total_recebimentos/t*100),i=Math.round(e.total_pagamentos/t*100);return`
        ...
        <div class="simple-chart">
            <div class="chart-bar-group">
                ...
                <div class="bar-container">
                    ...
                    <div class="bar bar-pag" style="height: ${i}%;"></div>
                </div>
                ...
                ${e.map(t=>{var a;return`
                    <tr>
                        <td>
                            ...
                            <div style="font-size: 0.75rem; color: var(--color-text-muted);">${t.cliente_id?((a=Ie.find(i=>i.id===t.cliente_id))==null?void 0:a.nome)||"Cliente":"Diversos"}</div>
                        </td>
    ...
    </div>`}function Tt(e){var r;const t=document.getElementById("financeiro-form"),a=document.getElementById("save-btn"),i=document.getElementById("cancel-btn"),o=document.getElementById("form-title");(r=document.getElementById("filter-type"))==null||r.addEventListener("change",async s=>{const x=s.target.value,b=x?Q.filter(h=>h.tipo===x):Q;document.getElementById("finance-list-container").innerHTML=ze(b)}),e.addEventListener("click",s=>{const x=s.target,b=x.closest(".edit-btn"),h=x.closest(".delete-btn");if(b){const y=b.dataset.id,u=Q.find(n=>n.id===y);if(u){W=y,document.getElementById("movimento-id").value=u.id,document.getElementById("descricao").value=u.descricao||"",document.getElementById("valor").value=u.valor.toString(),document.getElementById("data_vencimento").value=u.data_vencimento.split("T")[0],u.data_pagamento&&(document.getElementById("data_pagamento").value=u.data_pagamento.split("T")[0]),document.getElementById("cliente_id").value=u.cliente_id||"",document.getElementById("status").value=u.status;const n=document.querySelector(`input[name="tipo_movimento"][value="${u.tipo}"]`);n&&(n.checked=!0),o.textContent="Editar Lançamento",a.textContent="Atualizar Lançamento",i.style.display="block",window.scrollTo({top:0,behavior:"smooth"})}}if(h&&confirm("Tem certeza que deseja excluir?")){const y=h.dataset.id;J.delete(y).then(()=>{v("Excluído com sucesso","success"),fe(e)}).catch(()=>v("Erro ao excluir","error"))}}),i.addEventListener("click",()=>{Mt(t,a,i,o)}),t.addEventListener("submit",async s=>{s.preventDefault();const x=document.getElementById("status").value;let b=document.getElementById("data_pagamento").value;const h=document.getElementById("data_vencimento").value;x==="pago"&&!b&&(b=h);const y={tipo:document.querySelector('input[name="tipo_movimento"]:checked').value,descricao:document.getElementById("descricao").value,valor:parseFloat(document.getElementById("valor").value),data_vencimento:h,data_pagamento:b||void 0,cliente_id:document.getElementById("cliente_id").value||void 0,status:x},u=a.textContent;a.disabled=!0,a.textContent="Salvando...";try{W?(await J.update(W,y),v("Atualizado com sucesso!","success")):(await J.create(y),v("Lançamento criado!","success")),W=null,fe(e)}catch(n){v(n.message||"Erro ao salvar","error"),a.disabled=!1,a.textContent=u}})}function Mt(e,t,a,i){W=null,e.reset(),document.querySelector('input[name="tipo_movimento"][value="recebimento"]').checked=!0,i.textContent="Novo Lançamento",t.textContent="Salvar Lançamento",t.disabled=!1,a.style.display="none"}const je=[{id:"potencial",label:"Potencial",color:"#64748b"},{id:"contato",label:"Contato Realizado",color:"#3b82f6"},{id:"demonstracao",label:"Demonstração",color:"#8b5cf6"},{id:"orcamento",label:"Orçamento",color:"#eab308"},{id:"negociacao",label:"Negociação",color:"#f97316"},{id:"assinatura",label:"Assinatura",color:"#06b6d4"},{id:"fechado",label:"Fechado",color:"#22c55e"},{id:"encerrado",label:"Encerrado",color:"#ef4444"}];async function zt(e){e.innerHTML=`
    ...
    `;const a=e.documento_tipo==="cnpj",i=a?"PJ":"PF",o=a?"#3b82f6":"#10b981";return t.innerHTML=`
        <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 6px;">
            ...
            <div style="display: flex; flex-direction: column; align-items: flex-end; gap: 2px;">
                ...
                <span style="font-size: 0.65rem; background: ${o}20; color: ${o}; padding: 1px 4px; border-radius: 4px; font-weight: 500;">${i}</span>
            </div>
        </div>
    ...
    `,t.addEventListener("dragstart",r=>{r.dataTransfer.setData("text/plain",e.id),r.dataTransfer.effectAllowed="move",t.style.opacity="0.5"}),t.addEventListener("dragend",()=>{t.style.opacity="1"}),t}function he(e,t){const a=document.getElementById(`count-${e}`);a&&(a.textContent=t.toString())}function At(){document.querySelectorAll(".kanban-body").forEach(t=>{t.addEventListener("dragover",a=>{a.preventDefault(),a.dataTransfer.dropEffect="move",t.style.background="rgba(0,0,0,0.05)"}),t.addEventListener("dragleave",()=>{t.style.background="transparent"}),t.addEventListener("drop",async a=>{a.preventDefault(),t.style.background="transparent";const i=a.dataTransfer.getData("text/plain"),o=t.id.replace("stage-",""),r=document.querySelector(`div[data-id="${i}"]`);if(r&&r.parentElement!==t){const s=r.parentElement;s.removeChild(r),Se(s),t.appendChild(r),Se(t);try{await T.update(i,{pipeline_stage:o}),v("Estágio atualizado","success")}catch(x){console.error(x),v("Erro ao atualizar estágio","error"),window.location.reload()}}})})}function Se(e){const t=e.id.replace("stage-",""),a=e.children.length;he(t,a)}const B={reuniao:"#6366f1",call:"#10b981",visita:"#f59e0b",outro:"#94a3b8"};async function Dt(e){e.innerHTML=`
        <div class="page-header">
    ...
    `;const t=document.getElementById("agendamentos-list"),a=document.getElementById("agendamento-modal"),i=document.getElementById("agendamento-form"),o=document.getElementById("cliente-select"),r=document.getElementById("calendar-days"),s=document.getElementById("calendar-month-year"),x=document.getElementById("list-title"),b=document.getElementById("clear-filter"),h=document.querySelectorAll(".type-option"),y=document.getElementById("tipo-hidden");let u=new Date,n=null,w=[],l=null;async function p(){try{const[m,d]=await Promise.all([ie.list(),T.list()]);w=m,f(),O(d)}catch{v("Erro ao carregar dados","error")}}function f(){$(),_()}function _(){let m=[...w].sort((d,c)=>new Date(d.data_hora).getTime()-new Date(c.data_hora).getTime());if(n){const d=n.toISOString().split("T")[0];m=m.filter(c=>c.data_hora.startsWith(d)),x.innerHTML=`Compromissos - <span style="color: var(--color-primary);">${n.toLocaleDateString("pt-BR")}</span>`,b.style.display="block"}else{x.textContent="Próximos Compromissos",b.style.display="none";const d=new Date().toISOString();m=m.filter(c=>c.data_hora>=d.split("T")[0])}if(m.length===0){const d=n?"Nenhum compromisso para esta data.":"Nenhum compromisso agendado.";t.innerHTML=`<tr><td colspan="5" style="text-align:center; padding: 2.5rem; color: var(--color-text-muted);">
        ...
        `).join(""),t.querySelectorAll(".edit-btn").forEach(d=>{d.addEventListener("click",()=>G(w.find(c=>c.id===d.dataset.id)))}),t.querySelectorAll(".delete-btn").forEach(d=>{d.addEventListener("click",async()=>{if(confirm("Deseja excluir este agendamento?"))try{await ie.delete(d.dataset.id),v("Agendamento excluído"),p()}catch{v("Erro ao excluir","error")}})})}function $(){const m=u.getFullYear(),d=u.getMonth(),c=["janeiro","fevereiro","março","abril","maio","julho","agosto","setembro","outubro","novembro","dezembro"];s.textContent=`${c[d]} ${m}`;const k=new Date(m,d,1).getDay(),L=new Date(m,d+1,0).getDate();r.innerHTML="";const q=new Date(m,d,0).getDate();for(let S=k-1;S>=0;S--)r.innerHTML+=`<div class="calendar-day disabled" style="padding: 10px; text-align: center; color: var(--color-text-muted); opacity: 0.3; font-size: 0.85rem;">${q-S}</div>`;for(let S=1;S<=L;S++){const N=new Date(m,d,S),Pe=`${m}-${String(d+1).padStart(2,"0")}-${String(S).padStart(2,"0")}`,Ae=w.filter(me=>me.data_hora.startsWith(Pe)),X=n&&n.toDateString()===N.toDateString(),pe=new Date().toDateString()===N.toDateString(),P=document.createElement("div");P.className=`calendar-day ${X?"selected":""} ${pe?"today":""}`,P.style.cssText=`
                padding: 10px 5px;
                text-align: center;
                cursor: pointer;
                font-size: 0.85rem;
            ...
            `,P.addEventListener("click",()=>{n=N,f()}),r.appendChild(P)}}function C(m){switch(m){case"realizado":return"badge-success";case"cancelado":return"badge-danger";default:return"badge-warning"}}function z(m){return{reuniao:"Reunião",call:"Call",visita:"Visita",outro:"Outro"}[m]||m}function O(m){o.innerHTML='<option value="">Selecione um cliente...</option>'+m.map(d=>`<option value="${d.id}">${d.nome}</option>`).join("")}function j(m){y.value=m,h.forEach(d=>{const c=d;c.dataset.value===m?(c.style.borderColor=B[m],c.style.background=`${B[m]}15`):(c.style.borderColor="var(--color-border)",c.style.background="transparent")})}function G(m){if(l=(m==null?void 0:m.id)||null,document.getElementById("modal-title").textContent=m?"Editar Agendamento":"Novo Agendamento",m)i.cliente_id.value=m.cliente_id,i.titulo.value=m.titulo,i.data_hora.value=m.data_hora.substring(0,16),i.duracao_minutos.value=m.duracao_minutos,i.status.value=m.status,i.descricao.value=m.descricao||"",j(m.tipo);else{i.reset();const d=n?new Date(n):new Date;n?d.setHours(new Date().getHours()+1,0,0,0):d.setMinutes(d.getMinutes()+30),i.data_hora.value=new Date(d.getTime()-d.getTimezoneOffset()*6e4).toISOString().substring(0,16),j("reuniao")}a.classList.add("active")}function R(){a.classList.remove("active"),l=null}document.getElementById("prev-month").addEventListener("click",()=>{u.setMonth(u.getMonth()-1),$()}),document.getElementById("next-month").addEventListener("click",()=>{u.setMonth(u.getMonth()+1),$()}),b.addEventListener("click",()=>{n=null,f()}),h.forEach(m=>{m.addEventListener("click",()=>{j(m.dataset.value)})}),document.getElementById("new-agendamento-btn").addEventListener("click",()=>G()),document.getElementById("close-modal").addEventListener("click",R),document.getElementById("cancel-btn").addEventListener("click",R),i.addEventListener("submit",async m=>{m.preventDefault();const d=new FormData(i),c={cliente_id:d.get("cliente_id"),titulo:d.get("titulo"),data_hora:d.get("data_hora"),duracao_minutos:parseInt(d.get("duracao_minutos")),tipo:y.value,status:d.get("status"),descricao:d.get("descricao")};try{l?(await ie.update(l,c),v("Agendamento atualizado")):(await ie.create(c),v("Agendamento criado")),R(),p()}catch{v("Erro ao salvar agendamento","error")}}),p()}let xe=null;async function qt(e){var i;e.innerHTML=`
        <div class="page-header">
            <div>
    ...
    `,await Ot(document.getElementById("tab-content-calculator")),await Ee(document.getElementById("orcamentos-list-container"));const t=document.querySelectorAll(".tab-btn"),a=document.querySelectorAll(".tab-content");t.forEach(o=>{o.addEventListener("click",()=>{const r=o.dataset.tab;t.forEach(s=>{s.style.borderBottom="2px solid transparent",s.style.color="#666",s.classList.remove("active")}),o.style.borderBottom="2px solid var(--primary-color)",o.style.color="inherit",o.classList.add("active"),a.forEach(s=>s.style.display="none"),document.getElementById(`tab-content-${r}`).style.display="block",r==="history"&&Ee(document.getElementById("orcamentos-list-container"))})}),(i=document.getElementById("btn-config-pricing"))==null||i.addEventListener("click",()=>{oe("/configuracoes")})}async function Ot(e){var C,z,O,j,G,R,m,d;let t={};try{const c=await K.get("pricing_config?_t="+Date.now());c&&c.value&&(t=JSON.parse(c.value))}catch{console.warn("Using default pricing (fetch error)"),t={setup_base:2499,mensal_servidor:119.99,mensal_suporte:899.99,modulos:{crm:1500,erp:2e3,ai:2500}}}let a={premissas:{setup_base:t.setup_base||2499,mensal_servidor:t.mensal_servidor||119.99,mensal_suporte:t.mensal_suporte||899.99},custom_prices:{modulo_crm:((C=t.modulos)==null?void 0:C.crm)||1500,modulo_erp:((z=t.modulos)==null?void 0:z.erp)||2e3,modulo_ai_wa:((O=t.modulos)==null?void 0:O.ai)||2500,interpreta_texto:((j=t.customizacoes)==null?void 0:j.interpreta_texto)||199.99,interpreta_audio:((G=t.customizacoes)==null?void 0:G.interpreta_audio)||299.99,responde_texto:((R=t.customizacoes)==null?void 0:R.responde_texto)||199.99,responde_audio:((m=t.customizacoes)==null?void 0:m.responde_audio)||499.99,envio_email:((d=t.customizacoes)==null?void 0:d.envio_email)||199.99},modulos:{crm:!1,erp:!1,agente_ia_whatsapp:!0},integracoes:{agente_crm:!1,agente_erp:!1},customizacoes:{interpreta_texto:!1,interpreta_audio:!1,responde_texto:!1,responde_audio:!1,envio_email:!1},api_ia:{requisicoes_mes:0,custo_por_requisicao:.09}},i=null;e.innerHTML=`
        <style>
    ...
    `;const o=document.getElementById("calc-form-v2"),r=document.querySelectorAll(".calc-trigger"),s=document.getElementById("disp-setup"),x=document.getElementById("disp-mensal"),b=document.getElementById("setup-items"),h=document.getElementById("mensal-items"),y=document.getElementById("final-cliente-id"),u=document.getElementById("save-budget-btn"),n=document.getElementById("cancel-edit-btn"),w=document.getElementById("editing-badge"),l=document.getElementById("validation-msg"),p=document.getElementById("final-titulo"),f=document.getElementById("final-status");try{const c=await T.list();y.innerHTML='<option value="">Selecione um cliente...</option>'+c.map(k=>`<option value="${k.id}">${k.nome}</option>`).join("")}catch(c){console.error(c)}async function _(){const c=new FormData(o);a={premissas:a.premissas,custom_prices:a.custom_prices,modulos:{crm:c.get("module_crm")==="on",erp:c.get("module_erp")==="on",agente_ia_whatsapp:c.get("module_ai_wa")==="on"},integracoes:{agente_crm:c.get("int_ag_crm")==="on",agente_erp:c.get("int_ag_erp")==="on"},customizacoes:{interpreta_texto:c.get("cust_text_in")==="on",interpreta_audio:c.get("cust_audio_in")==="on",responde_texto:c.get("cust_text_out")==="on",responde_audio:c.get("cust_audio_out")==="on",envio_email:c.get("cust_email")==="on"},api_ia:{requisicoes_mes:parseInt(c.get("api_reqs"))||0,custo_por_requisicao:parseFloat(c.get("api_cost"))||.09}};try{const L=await V.calculate({configuracao:a});s.textContent=I(L.valor_setup),x.textContent=I(L.valor_mensal),b.innerHTML=Object.entries(L.detalhes.setup||{}).map(([q,S])=>`
                <div class="item-row"><span>${q}</span><span>${I(S)}</span></div>
            `).join("")+`<div class="item-row subtotal"><span>Total Setup</span><span>${I(L.valor_setup)}</span></div>`,h.innerHTML=Object.entries(L.detalhes.mensal||{}).map(([q,S])=>`
                <div class="item-row"><span>${q}</span><span>${I(S)}</span></div>
            `).join("")+`<div class="item-row subtotal"><span>Total Mensal</span><span>${I(L.valor_mensal)}</span></div>`}catch(L){console.error("Calc error",L)}}xe=c=>{var k;i=c.id,a=c.configuracao,o.querySelector('[name="module_crm"]').checked=a.modulos.crm,o.querySelector('[name="module_erp"]').checked=a.modulos.erp,o.querySelector('[name="module_ai_wa"]').checked=a.modulos.agente_ia_whatsapp,o.querySelector('[name="int_ag_crm"]').checked=a.integracoes.agente_crm,o.querySelector('[name="int_ag_erp"]').checked=a.integracoes.agente_erp,o.querySelector('[name="cust_text_in"]').checked=a.customizacoes.interpreta_texto,o.querySelector('[name="cust_audio_in"]').checked=a.customizacoes.interpreta_audio,o.querySelector('[name="cust_text_out"]').checked=a.customizacoes.responde_texto,o.querySelector('[name="cust_audio_out"]').checked=a.customizacoes.responde_audio,o.querySelector('[name="cust_email"]').checked=a.customizacoes.envio_email,o.querySelector('[name="api_reqs"]').value=String(a.api_ia.requisicoes_mes),o.querySelector('[name="api_cost"]').value=String(a.api_ia.custo_por_requisicao),o.querySelector('[name="descricao"]').value=c.descricao||"",y.value=c.cliente_id,p.value=c.titulo,f.value=c.status,f.disabled=!1,w.style.display="block",n.style.display="block",u.innerHTML="💾 Atualizar Orçamento",_(),(k=document.querySelector('[data-tab="calculator"]'))==null||k.click()};function $(){i=null,o.reset(),p.value="",y.value="",f.value="rascunho",f.disabled=!0,w.style.display="none",n.style.display="none",u.innerHTML="💾 Salvar Orçamento",_()}n.addEventListener("click",$),r.forEach(c=>{c.addEventListener("change",_),c.addEventListener("input",_)}),u.addEventListener("click",async()=>{var S;const c=y.value,k=p.value||"Novo Orçamento v2",L=o.querySelector('textarea[name="descricao"]').value;if(!c){l.style.display="block";return}l.style.display="none";const q=u.innerHTML;u.innerHTML="Salvando...",u.disabled=!0;try{if(i){const N=f.value;await V.update(i,{titulo:k,descricao:L,configuracao:a,status:N}),v("Orçamento atualizado!","success")}else await V.create({cliente_id:c,titulo:k,descricao:L,configuracao:a}),v("Orçamento salvo!","success");$(),confirm("Deseja ver o histórico agora?")&&((S=document.querySelector('[data-tab="history"]'))==null||S.click())}catch{v("Erro ao salvar","error")}finally{u.innerHTML=q,u.disabled=!1}}),_()}async function Ee(e){e.innerHTML='<div class="loading"><div class="spinner"></div></div>';try{const t=await V.list();if(t.length===0){e.innerHTML='<div class="empty-state"><div class="empty-state-icon">📋</div>Nenhum orçamento salvo</div>';return}e.innerHTML=`
            <table class="table">
                <thead>
                    <tr>
                        <th>Data</th>
        ...
        `,document.querySelectorAll(".view-orc-btn").forEach(a=>{a.addEventListener("click",i=>{const o=i.target.closest("tr");if(o&&o.dataset.json){const r=JSON.parse(o.dataset.json);xe&&xe(r)}})}),document.querySelectorAll(".delete-orc-btn").forEach(a=>{a.addEventListener("click",async i=>{var r;const o=i.target.dataset.id||((r=i.target.parentElement)==null?void 0:r.dataset.id);if(o&&confirm("Tem certeza que deseja excluir este orçamento?"))try{await V.delete(o),v("Orçamento excluído","success"),Ee(e)}catch{v("Erro ao excluir","error")}})})}catch{e.innerHTML='<div class="empty-state">Erro ao carregar histórico.</div>'}}function Rt(e){switch(e){case"aprovado":return"success";case"rejeitado":return"danger";case"enviado":return"info";default:return"warning"}}async function Nt(e){var i,o,r,s,x,b,h,y,u,n,w;e.innerHTML=`
...
${p.message}`)}})}const _e=document.getElementById("app");async function D(e,t){if(!await Te()){le(_e);return}const i=gt(_e,e);await t(i)}M("/",async()=>{await Te()?oe("/dashboard"):le(_e)});M("/dashboard",()=>D("dashboard",bt));M("/clientes",()=>D("clientes",ve));M("/funil",()=>D("funil",zt));M("/agendamento",()=>D("agendamento",Dt));M("/orcamento",()=>D("orcamento",qt));M("/contratos",()=>D("contratos",ye));M("/projetos",()=>D("projetos",xt));M("/financeiro",()=>D("financeiro",fe));M("/configuracoes",()=>D("configuracoes",Nt));we();
